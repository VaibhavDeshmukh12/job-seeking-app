...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://jobseekingapplication.onrender.com/api/v1/job/getMyJob",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`https://jobseekingapplication.onrender.com/api/v1/job/updateJob/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(`https://jobseekingapplication.onrender.com/api/v1/job/deleteJob/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
